  ...
  return (
    <div className="border-white-secondary w-full border bg-white p-5">
      <div className="flex items-center justify-between 2xl:mb-5">
        ...
        <span className="border-white-secondary flex items-center gap-1 border px-2.5 py-1 text-sm font-semibold text-black/80 2xl:text-base">
          <Star size={13} className="fill-yellow-400 text-yellow-400" />
          {hotel.rating}
        </span>
      </div>

      <h2 className="mb-2 text-2xl font-bold text-black/80 2xl:mb-5 2xl:text-2xl">{hotel.name}</h2>
