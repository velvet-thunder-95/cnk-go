    ...
    <div className="border-white-secondary border-roundness w-full border bg-white p-5">
      <div className="flex items-center justify-between 2xl:mb-5">
        <div className="flex items-center gap-3">
          ...
          <span className="text-base font-semibold text-black/70 2xl:text-lg">Hotel</span>
        </div>
        <span className="border-white-secondary flex items-center gap-1 border px-2.5 py-1 text-sm font-semibold text-black/70 2xl:text-base">
          <Star size={13} className="fill-yellow-400 text-yellow-400" />
          {hotel.rating}
        </span>
      </div>

      <h2 className="mb-2 text-2xl font-bold text-black/70 2xl:mb-5 2xl:text-xl">{hotel.name}</h2>
      ...
      <div className="grid grid-cols-4 gap-4 bg-[#F8F9FA] px-4 py-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <span className="text-sm font-semibold text-black/70 2xl:text-base">{hotel.nights}</span>
        </div>
        <div className="flex flex-col gap-1">
          <span className="text-gray text-[10px] font-semibold tracking-wider uppercase 2xl:text-xs">
            Total
