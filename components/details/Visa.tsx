  ...
  return (
    <div className="border-white-secondary w-full border bg-white p-5">
      <div className="mb-5 flex items-center gap-3">
        ...
        <span className="text-base font-semibold text-black/80 2xl:text-lg">Visa</span>
      </div>

      <div className="flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <span className="text-gray text-sm 2xl:text-base">Type</span>
          <span className="text-sm font-semibold text-black/80 2xl:text-base">{visa.type}</span>
        </div>

        <div className="flex items-center justify-between">
          <span className="text-gray text-sm 2xl:text-base">Cost</span>
          <span className="text-sm font-semibold text-black/80 2xl:text-base">₹{visa.cost}</span>
        </div>
